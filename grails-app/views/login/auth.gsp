									...
									<table
										...
										<tr>
											<td colspan="2" class='sysinflame'>By logging in to this
												application I hereby acknowledge, that according to the <a
												href="http://www.dfg.de/download/pdf/dfg_im_profil/reden_stellungnahmen/download/empfehlung_wiss_praxis_1310.pdf"
												target="_blank"
												style="color: blue; text-decoration: underline">Safeguarding
													Good Scientific Practice Memorandum, DFG</a> I have to cosult a
												<b>(bio)medical informaticist (data management) and a
													statistician or an epidemiologist (analysis)</b> prior to
												publishing this data in order to ensure good scientific
												practice.
											</td>
											<tr>
											<td>&nbsp;</td>
											...
											<tr>
												<td class='sysinflame' colspan="2" style="color: red">
													...
													reproducibility and may end up in a case of suspected
													scientific misconduct.</td>
											</tr>
											<tr>
												<td>&nbsp;</td>
											</tr>
											...
											<tr>
											<td class='sysinflame' colspan="2">
												"A scientific finding normally is a complex
												product of many single working steps. In all experimental
												sciences, the results reported in publications are generated
												through individual observations or measurements adding up to
												preliminary findings. Observation and experiment, as well as
												numerical calculation (used as an independent method or to
												support data analysis), first produce "data". […]
												Experiments and numerical calculations can only be repeated
												if all important steps are reproducible. For this purpose,
												they must be recorded. Every publication based on
												experiments or numerical simulations includes an obligatory
												chapter on "materials and methods" summing up these records
												in such a way that the work may be reproduced in another
												laboratory."</td>
										</tr>
